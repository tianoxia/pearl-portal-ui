...
@Component({
  selector: 'app-biweekly-pay-periods',
  templateUrl: './biweekly-pay-periods.component.html',
  styleUrls: ['./biweekly-pay-periods.component.css']
})
export class BiWeeklyPayPeriodsComponent implements OnInit {
...
limit = 10;
  constructor(public alertService: AlertService,
    ...
    back(): void {
    this.router.navigate(['view-pay-periods/pay-period-dashboard'], {queryParams: { pagetype: this.pageType, payfrequency: 'Bi-Weekly'}});
  }
  ngOnInit() {
    this.spinner.show();
  ...
  private loadData() {
    ...
    this.dataService.getAllPayPeriods('B')
