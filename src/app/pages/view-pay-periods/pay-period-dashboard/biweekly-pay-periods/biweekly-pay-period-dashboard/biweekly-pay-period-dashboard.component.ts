...
@Component({
  ...
  templateUrl: './biweekly-pay-period-dashboard.component.html',
  styleUrls: ['./biweekly-pay-period-dashboard.component.css'],
  providers: [CurrencyPipe],
  encapsulation: ViewEncapsulation.None
})
export class BiWeeklyPayPeriodDashboardComponent implements OnInit {
  weekEndings: Date[] = [];
  payDate: Date;
  payType: string;
  ...
  back(): void {
    this.router.navigate(['view-pay-periods/pay-period-dashboard/biweekly-pay-periods'], {queryParams: { pagetype: this.pageType}});
  }
  ngOnInit() {
    window.scrollTo(0, 0);
    ...
    this.invoiceService.getLogoImage().subscribe(res => {
      ...
      reader.onloadend = () => {
        const request: InvoiceReportRequest = {
          ...
          weekEnding2: this.datePipe.transform(this.weekEndings[1], 'yyyy-MM-dd'),
