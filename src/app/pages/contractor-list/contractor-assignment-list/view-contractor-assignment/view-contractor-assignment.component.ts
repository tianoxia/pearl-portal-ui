...
@Component({
  selector: 'app-view-contractor-assignment',
  templateUrl: './view-contractor-assignment.component.html',
  styleUrls: ['./view-contractor-assignment.component.css'],
...
export class ViewAssignmentComponent implements OnInit {
  ...
  constructor(
    ...
    back(): void {
      this.router.navigate([`/view-contractor/${this.contractorId}`]);
    }
  ngOnInit() {
    window.scrollTo(0, 0);
    this.spinner.show();
